...
icon = Image.open("/Users/karthimurugesan/Desktop/OCR/download.png")
st.set_page_config(page_title="Extracting Business Card Data with OCR | By Karthi ",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Karthi*!"""})
st.markdown("<h2 style='text-align: center; color: Red;'>Extracting Business Card Data with OCR</h2>",
...
if selected=="Home":
    ...
    with col1:
        st.image(Image.open("/Users/karthimurugesan/Desktop/OCR/download.png"))
        st.markdown("## :green[**Technology used:**] Python,EasyOCR,Streamlit,SQL,Pandas")
